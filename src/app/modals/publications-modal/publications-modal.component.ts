...
import { Conference, FIREBASE_PATHS } from 'src/app/models/content.models';
...
export class PublicationsModalComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PublicationsModalComponent>,
  ...
  async addPublication() {
    if (this.type == 'add') {
      ...
      await this.databaseService.addPublicationData(FIREBASE_PATHS.CONFERENCES, this.publicationData);
